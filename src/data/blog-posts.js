export const blogPosts = [
  {
    id: 1,
    slug: '5-dicas-dentes-saudaveis',
    title: '5 dicas para manter os dentes saudáveis',
    excerpt: 'Descubra as melhores práticas para manter sua saúde bucal em dia e ter um sorriso sempre saudável.',
    content: `
...
**Precisa de uma avaliação profissional? Agende sua consulta conosco!**
    ...
    seo: {
      title: '5 Dicas Essenciais para Manter os Dentes Saudáveis | Clínica Sorriso Perfeito',
      description: 'Descubra as 5 dicas fundamentais para manter seus dentes saudáveis e um sorriso perfeito. Guia completo de cuidados bucais.',
      keywords: 'dentes saudáveis, cuidados bucais, saúde dental, prevenção cáries'
    }
  },
  {
    id: 2,
    slug: 'quando-usar-aparelho-ortodontico',
    title: 'Quando é hora de usar aparelho ortodôntico?',
    excerpt: 'Saiba identificar os sinais de que você ou seu filho precisam de tratamento ortodôntico.',
    content: `
...
**Quer saber qual o melhor tratamento para seu caso? Agende uma avaliação ortodôntica!**
    `,
    image: 'https://images.pexels.com/photos/6627374/pexels-photo-6627374.jpeg?auto=compress&cs=tinysrgb&w=800&h=400&fit=crop',
    publishDate: '2024-10-10',
    readTime: '4 min',
    tags: ['ortodontia', 'aparelho', 'tratamento'],
    author: 'Dr. João Silva',
    seo: {
      title: 'Quando Usar Aparelho Ortodôntico? Guia Completo | Clínica Sorriso Perfeito',
      description: 'Descubra quando é hora de usar aparelho ortodôntico. Sinais, idade ideal e tipos disponíveis. Guia completo sobre ortodontia.',
      keywords: 'aparelho ortodôntico, ortodontia, dentes tortos, tratamento ortodôntico'
    }
  },
  {
    id: 3,
    slug: 'mitos-verdades-clareamento-dental',
    title: 'Mitos e verdades sobre clareamento dental',
    excerpt: 'Esclareça suas dúvidas sobre clareamento dental e descubra o que é mito e o que é verdade.',
    content: `
...
**Quer um sorriso mais branco e saudável? Consulte nossos especialistas!**
    ...
    seo: {
      title: 'Mitos e Verdades sobre Clareamento Dental | Clínica Sorriso Perfeito',
      description: 'Descubra os principais mitos e verdades sobre clareamento dental. Esclareça suas dúvidas com nosso guia completo.',
      keywords: 'clareamento dental, mitos clareamento, verdades clareamento, estética dental'
    }
  },
  {
    id: 4,
    slug: 'como-escolher-escova-dente-ideal',
    title: 'Como escolher a escova de dente ideal',
    excerpt: 'Guia completo para escolher a escova de dente perfeita para suas necessidades.',
    content: `
...
**Dúvidas sobre qual escova usar? Consulte nossos profissionais para uma recomendação personalizada!**
    `,
    image: 'https://images.pexels.com/photos/3779709/pexels-photo-3779709.jpeg?auto=compress&cs=tinysrgb&w=800&h=400&fit=crop',
    publishDate: '2024-09-28',
    readTime: '3 min',
    tags: ['higiene bucal', 'escova de dente', 'cuidados'],
    author: 'Dr. Carlos Mendes',
    seo: {
      title: 'Como Escolher a Escova de Dente Ideal | Guia Completo | Clínica Sorriso Perfeito',
      description: 'Guia completo para escolher a escova de dente perfeita. Tipos de cerdas, tamanhos e dicas de profissionais.',
      keywords: 'escova de dente, higiene bucal, cerdas macias, escova elétrica'
    }
  },
  {
    id: 5,
    ...
    excerpt: 'Descubra como a alimentação influencia diretamente na saúde dos seus dentes e gengivas.',
    content: `
...
**Quer uma orientação nutricional personalizada para sua saúde bucal? Agende uma consulta!**
    ...
    readTime: '5 min',
    tags: ['alimentação', 'saúde bucal', 'nutrição', 'prevenção'],
